                                ...
                                <div class="row-fluid">
                                    ...
                                    <div class="alert alert-info" style="margin: 10px;">
                                        ...
                                        <ol>
                                            ...
                                            <li><#FW_desc5#></li>
                                            <li><#FW_desc6#></li>
											<li>Nếu xuất hiện lỗi: "Firmware update: Firmware image is corrupted! Please check free space in /tmp"
											Vui lòng nhấn nút /tmp để tạm thời tăng dung lượng chứa file, sau đó tải lên file mới! 
<input id="bingtmp" class="btn btn-success" style="width:50px display:none;" type="button" name="bingtmp" value="Mở rộng/tmp" onclick="submitInternet('bigtmp');" /></li>
                                        </ol>
                                    </div>
